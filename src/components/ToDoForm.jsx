...
const ToDoForm = () => {
  ...
  return (
    <form className='my-4 mx-8 flex' onSubmit={handleSubmit}>
        <select className='p-3 border-2 border-blue-900 text-blue-950 border-r-0 focus:ring-2 focus:ring-blue-500 outline-none rounded-l'
        name='category'
        ...
        {toDo && (
            <>
                <button className='bg-gray-500 px-6 py-3 hover:bg-gray-600 text-white focus:ring-2 focus:ring-gray-300'
                onClick={onCancel}>
                    Cancel
                </button>
                <button className='bg-blue-900 px-6 py-3 hover:bg-blue-950 text-white focus:ring-2 focus:ring-blue-500 rounded-r'
                onClick={onEdit}>
                    Update
                </button>
            </>
